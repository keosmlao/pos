...
- **ປ່ອງໜ້າຂາຍ (cashier) ແຍກຕ່າງຫາກ** — ເມນູ POS → ເປີດປ່ອງໜ້າຂາຍ ຫຼື F9
  - ບໍ່ມີແຖບເມນູ (ກົດ Alt ຈຶ່ງເຫັນ), ຈື່ຂະໜາດ/ຕຳແໜ່ງ/ເຕັມຈໍ ຂອງມັນເອງ
  - ລິ້ງໄປໜ້າຫຼັງບ້ານ (`/admin`) ຈະເປີດໃນປ່ອງຫຼັກແທນ — ປ່ອງໜ້າຂາຍລັອກຢູ່ໜ້າຂາຍ
  - ຕັ້ງໃຫ້ເປີດປ່ອງນີ້ທັນທີຕອນເປີດແອັບໄດ້ (ຕັ້ງຄ່າ Server → ✅ ເປີດປ່ອງໜ້າຂາຍທັນທີ)
