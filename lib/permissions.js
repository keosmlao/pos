...
export const API_RULES = [
  ...
  { prefix: '/api/admin/barcode-generator', menu: '/admin/barcode-generator' },
  ...
  { prefix: '/api/admin/vat-sales-report', menu: '/admin/vat-sales-report' },
  { prefix: '/api/admin/cashier-receipts', menu: '/admin/cashier-receipts' },

  // ── ຈັດການບິນ ອມພ ─────────────────────────────────────────────────────
  { prefix: '/api/admin/vat-invoices', menu: '/admin/vat-invoice-submit' },
  { prefix: '/api/admin/vat-invoice-report', menu: '/admin/vat-invoice-report' },
  ...
  // ── ລາຍງານ ─────────────────────────────────────────────────────────────
  { prefix: '/api/admin/reports/payables', menu: '/admin/reports/payables' },
  { prefix: '/api/admin/reports/receivables', menu: '/admin/reports/receivables' },
