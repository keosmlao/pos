...
export const adminMenuSections = [
  ...
  },
  {
    ...
    items: [
      { path: '/admin/vat-invoice-submit', icon: '\u{1F4E4}', iconName: 'Send', label: 'ສົ່ງຂໍ້ມູນບິນອາກອນ' },
      { path: '/admin/vat-invoice-report', icon: '\u{1F4CA}', iconName: 'FileSpreadsheet', label: 'ລາຍງານອອກບິນອາກອນ' },
    ],
  },
  {
    title: 'ການເງິນ',
