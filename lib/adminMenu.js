...
export const adminMenuSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/laybys', icon: '\u{1F4B0}', iconName: 'Banknote', label: 'Layby / ມັດຈຳ' },
      { path: '/admin/sales', icon: '\u{1F4CB}', iconName: 'ClipboardList', label: 'ປະຫວັດການຂາຍ' },
      { path: '/admin/credit-sales', icon: '\u{1F9FE}', iconName: 'Receipt', label: 'ບິນຂາຍຕິດໜີ້' },
      { path: '/admin/returns', icon: '\u{21A9}', iconName: 'Undo2', label: 'ຮັບຄືນ / ຄືນເງິນ' },
