...
export const PURCHASE_RETURN_NUMBER_DEFAULTS = {
  purchase_return_number_template: '{{prefix}}-{{YYYY}}{{MM}}-{{seq}}',
  purchase_return_number_prefix: 'PRT',
  purchase_return_number_seq_digits: 4,
  purchase_return_number_seq_reset: 'monthly',
  purchase_return_number_start: 1,
};
...
export const DOCUMENT_NUMBER_TYPES = [
  ...
  {
    key: 'purchase_return',
    label: 'ໃບສົ່ງຄືນຜູ້ສະໜອງ',
    title: 'ເລກໃບສົ່ງຄືນຜູ້ສະໜອງ',
    subtitle: 'ໃຊ້ສຳລັບເອກະສານສົ່ງສິນຄ້າຄືນໃຫ້ຜູ້ສະໜອງ',
    defaults: PURCHASE_RETURN_NUMBER_DEFAULTS,
  },
  {
